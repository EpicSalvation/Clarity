 ...
 * (Video playback disabled fallback)
 *
...
Window {
    ...
    Component.onCompleted: {
        copyToContainerA()
        console.log("OutputDisplay QML loaded with transition support (no video)")
    }
    ...
    Item {
        ...
        // Solid color background (video fallback)
        Rectangle {
            anchors.fill: parent
            color: root.backgroundTypeA === "solidColor" || root.backgroundTypeA === "video"
                   ? root.backgroundColorA : "black"
            visible: root.backgroundTypeA === "solidColor" || root.backgroundTypeA === "video"
        }
    ...
    Item {
        ...
        Rectangle {
            anchors.fill: parent
            color: root.backgroundTypeB === "solidColor" || root.backgroundTypeB === "video"
                   ? root.backgroundColorB : "black"
            visible: root.backgroundTypeB === "solidColor" || root.backgroundTypeB === "video"
        }
